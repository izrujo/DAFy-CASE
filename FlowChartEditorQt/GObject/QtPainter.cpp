...
void QtPainter::Begin(QPaintDevice *device) {
	this->qPainter->begin(device);
}
...
void QtPainter::DrawTextQ(const QRectF &rectangle, int flags, const QString &text) {
	this->qPainter->drawText(rectangle, flags, text);
}

void QtPainter::DrawTextQ(const QRect &rectangle, int flags, const QString &text) {
	this->qPainter->drawText(rectangle, flags, text);
}

void QtPainter::DrawTextQ(int x, int y, const QString &text) {
