...
public:
	...
	virtual void DrawTextQ(const QRectF& rectangle, int flags, const QString& text);
	virtual void DrawTextQ(const QRect& rectangle, int flags, const QString& text);
	virtual void DrawTextQ(int x, int y, const QString& text);
...
inline QPixmap* QtPainter::GetPixmap() const {
	return this->qPixmap;
}
inline QPainter* QtPainter::GetPainter() const {
